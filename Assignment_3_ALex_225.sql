...
create table stocks(
store_id INT auto_increment,product_id INT,quantity INT, primary key (store_id,product_id));
...
shipped_date DATE,
store_id INT,
-- constraint orders_ibfk_2 primary key (order_id),
...
order_id INT,
item_id INT,primary key(order_id,item_id),
quantity INT,
list_price DECIMAL(10,2),
discount DECIMAL(4,2),
-- constraint orders__ibfk_2 primary key (order_id),
...
INSERT INTO production.products(product_id, product_name, brand_id, category_id, model_year, list_price) VALUES(215,'Electra Queen of Hearts 3i - 2018',1,3,2018,7499);
...
INSERT INTO sales.orders(order_id, customer_id, order_status, order_date, required_date, shipped_date, store_id,staff_id) VALUES(579,160,
4,'20161127','20161130','20161129',3,8);
